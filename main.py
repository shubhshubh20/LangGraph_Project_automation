...
if __name__ == "__main__":
    ...
    telegram_thread = threading.Thread(target=main, args=(episode_number,), name="TelegramBot", daemon=True)
    ...
    polling_thread = threading.Thread(target=poll_job_status, args=(shutdown_event,), name="JobStatusPoller", daemon=True)
